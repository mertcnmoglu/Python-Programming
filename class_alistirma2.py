...
class Köpek(Hayvan):
    ...
    def __str__(self):
        ...
        return "Beslenme: {} İc Güdü: {} ayak sayilari : {} cıkardıkları ses: {} ".format(self.beslenme,self.ic_güdü,self.ayak_sayisi,self.cıkardıgı_ses)
...
class Kus(Hayvan):
    ...
    def __str__(self):
        ...
        return "Beslenme : {} İcgüdü: {} ucma ozelligi : {} cıkardıkları ses: {}".format(self.beslenme,self.ic_güdü,self.ic_güdü,self.cıkardıgı_ses)
...
class At(Hayvan):
    ...
    def __str__(self):
        ...
        return "Beslenme: {} İc güdü: {} Nal sayisi : {} Boy: {}".format(self.beslenme,self.ic_güdü,self.nal_sayisi,self.boy)
